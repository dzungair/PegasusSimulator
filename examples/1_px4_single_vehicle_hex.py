...
from pegasus.simulator.logic.backends.mavlink_backend_hex import (
    MavlinkBackendHex,
        ...
        mavlink_config = MavlinkBackendHexConfig(
            {
                ...
                "px4_vehicle_model": "gazebo-classic_typhoon_h480",  # CHANGE this line to 'iris' if using PX4 version bellow v1.14
                # "px4_vehicle_model": "hexa_x_tilt" # CHANGE this line to 'iris' if using PX4 version bellow v1.14
            }
        )
