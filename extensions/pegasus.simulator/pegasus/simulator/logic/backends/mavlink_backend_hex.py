...
class MavlinkBackendHexConfig(BackendConfig):
    """
    ...
    def __init__(self, config={}):
        ...
        self.input_scaling = config.get(
            "input_scaling", [1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0]
        )
...
class MavlinkBackendHex(Backend):
    ...
    def update_state(self, state: State):
        ...
        self._sensor_data.sim_ind_airspeed = int(np.max([0.0, body_vel[0] * 100]))
    ...
    def send_airspeed_msgs(self, time_usec: int):
        ...
        try:
            ...
            carb.log_warn(
                "Could not send airspeed data through mavlink. Exeption: " + str(e)
            )
