...
class Lidar(GraphicalSensor):
    ...
    def __init__(self, lidar_name, config={}):
        ...
        super().__init__(sensor_type="Lidar", update_rate=config.get("frequency", 30.0))
        ...
        self._sensor_configuration = config.get(
    ...
    def initialize(self, vehicle):
        ...
        self._stage_prim_path = get_stage_next_free_path(
            ...
            self._vehicle.prim_path + "/body/" + self._lidar_name,
            False,
        )
